...
ga_init_env() {
  ...
  EXPECTED_HOOK_BINDINGS=(
    ...
    "PreToolUse	enforce-harness-critical.sh	Write|Edit|MultiEdit"
    ...
    "PreToolUse	validate-pre-write-raw.sh	Write|Edit"
    ...
    "SubagentStart	inject-scope-part-01.sh	"
    "SubagentStart	inject-scope-part-02.sh	"
    "SubagentStart	inject-scope-part-03.sh	"
    "SubagentStart	inject-scope-part-04.sh	"
    "SubagentStart	inject-scope-part-05.sh	"
    "SubagentStart	inject-scope-part-06.sh	"
    "SubagentStart	inject-scope-part-07.sh	"
    "SubagentStart	inject-scope-part-08.sh	"
