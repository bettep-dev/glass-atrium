...
| `CLAUDED_DOCS_HTML_ROOT` | optional | HTML-primary FS root override for new POST/PUT documents · absolute path or `~/`-prefixed · unset default = `~/.glass-atrium/monitor/data/documents/` (monitor-internal) |
...
> `~/.glass-atrium/monitor/data/documents/`). That path is monitor-internal and
