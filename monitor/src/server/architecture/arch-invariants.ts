...
export const ARCH_INVARIANTS: ArchInvariants = {
	...
	scopedShared: 8,
	skills: 15,
	// 이 필드는 hooks.PreToolUse 와 달리 repo 결합이 아니라 LIVE 결합이며, 관례는 "라이브 카운트에
	// 맞춰 sync" 다. 55 였던 값은 릴리스로 advisory-worktree-writer-lock.sh (PR #158) 가 라이브에
	// 안착한 뒤 56 으로 sync 했다 (2026-08-16 확인: 라이브 == repo == 56).
	uniqueHookBasename: 56,
	hooks: {
