...
[/AGENT-COMPOSITION] */
// Synthesized verdict fixture: a dev type spawned in the code appears in no clause of the
// declaration, which is how a silently-added implementation dev would bypass the verify contract.
...
await agent('glass-atrium-dev-node', { goal: 'quietly implement a second slice' });
