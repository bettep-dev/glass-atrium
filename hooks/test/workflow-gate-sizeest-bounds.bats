...
#
# BASH GATING SEMANTICS: a mid-body bare `[[ ]]` / `(( ))` is inert on macOS bash 3.2.57 but GATES on
#   CI's bash 5.3.9 (measured, bats 1.13.0 both legs — bash is the variable, not bats), so every
#   assertion is written `[[ ... ]] || return 1`.
