...
- **HTML vs agent-only branching spec**:
  ...
  - **agent-only record** → LLM autonomous {md, yaml, json, txt} selection (MD default forcing discontinued) · decision matrix canonical `glass-atrium-intel-reporter.md` Format Selection Matrix — HTML · TOC · visual-decoration toggle FORBIDDEN · viewer default-hide
