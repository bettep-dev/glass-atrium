...
- **Non-waiver (binding on YOU, not on the delegation)**: the standing jobs of this gate — the premise audit and the first-link question above, and every other standing job this section names — are BINDING and are NOT waivable by delegation phrasing.
