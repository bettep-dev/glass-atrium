...
Rejected hypotheses carry forward: maintain the running H-list across cycles with each rejection's disproof evidence, never re-test a hypothesis already disproven, and re-read the prior cycle's evidence before selecting the next technique.
